...
for RANGE_LOCK_VARIANT in $(seq 3 3)
do
    ...
    do
        ...
        ./build/benchmark/LeanStore_YCSB -ycsb_read_ratio=100 -ycsb_exec_seconds=10 -ycsb_payload_size=1048576 -ycsb_record_count=1000 -bm_virtual_gb=128 -bm_physical_gb=32 -db_path=/blk/s0 -blob_logging_variant=1 -worker_count=$WORKER_COUNT -range_lock_variant=$RANGE_LOCK_VARIANT >> "$OUTPUT_FILE"
